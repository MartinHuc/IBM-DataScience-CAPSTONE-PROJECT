...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div(dcc.Graph(id='success-pie-chart')),# I add> ",figure=fig"
                                html.Br(),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(filtered_df, values='class', names='Launch Site', title='success-pie-chart')
        return fig
    else:
        title = f"Total Success-Failure Launches for site {entered_site}"
